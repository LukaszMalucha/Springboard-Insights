...
#
# from core.models import MyProfile, Course
#
#
...
#
#     def test_creating_empty_Course(self):
#         self.assertTrue(self.empty_course)
#
#     def test_Course_str(self):
#         self.assertEqual(str(self.course), "test")
#
#     def test_empty_Course_str(self):
#         self.assertEqual(str(self.empty_course), "none")
