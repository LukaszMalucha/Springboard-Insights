...
<div class="row plain-element">
  ...
  <div class="row banner">
    <div class="col-xs-0 col-sm-0 col-md-3 col-lg-2 text-left plain-element">
      <img src="https://springboard-analytics.s3-eu-west-1.amazonaws.com/static/img/online-banner.jpg" class="img responsive img-banner">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 plain-element">
      <div class="row summary">
        <div class="box">
          <h5>Online Degrees</h5>
          <h6>Online degrees are ideal for adults seeking a career change or high school graduates looking for an early start.
            Springboard.ie offers convenient and accelerated programs that can drastically reduce the cost of your degree.
          </h6>
        </div>
      </div>
    </div>
