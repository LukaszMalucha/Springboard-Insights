...
<div class="row plain-element">
  ...
  <div class="row top-menu">
      <ul>
       ...
       <li>
          <router-link class="active" :to="{name: 'fastest-diploma'}">The Fastest Diploma</router-link>
        </li>
        <li>
    ...
    <div class="row row-cards">
       <table id="courseTable">
        ...
        <tr>
          ...
          <th class="text-center" onclick="sortTableInt(2)">Duration</th>
...
export default {
  ...
  methods: {
    ...
    ...mapActions(['fetchFastestDiploma',]),
   },
  computed: {
//  Search courses function
  ...
  created() {
    this.fetchFastestDiploma()
    document.title = "The Fastest Diploma";
  }
}
</script>